...
## Algorithm
1.1.In Random Forest n number of random records are taken from the data set having
k number of records.
...
## Output:
![image](https://user-images.githubusercontent.com/95537476/169959348-ef47e691-b229-4a88-bded-a9da59b19354.png)
